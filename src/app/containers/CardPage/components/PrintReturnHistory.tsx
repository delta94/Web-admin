...
const PrintReturnHistory = React.forwardRef<HTMLDivElement, Props>(
  (props, ref) => {
      ...
      <div ref={ref} {...props}>
        ...
        <style
          ...
          dangerouslySetInnerHTML={{
            __html:
              '\n<!--\nh3.printer__body-title-Size{font-size:20px}\n-->\n',
          }}
        />
        <div
            ...
            <div className="printer__top">
              <div className="printer__top__header" style={{ display: 'flex' }}>
                <div className="printer__header-left">
                  <img
                    src={!_.isEmpty(setting) ? setting.logoUrl : ''}
                    alt="Logo-K"
                    width={90}
                    height={60}
                  />
                ...
                >
                  ...
                  >
                    ...
                    <div className="birthday-right">
                      ...
                      >
                        {AppHelper.getYearBirthDay(_.get(card, 'birthday'))}
                      </p>
                    </div>
                  </div>
                </div>
...
export default PrintReturnHistory;
